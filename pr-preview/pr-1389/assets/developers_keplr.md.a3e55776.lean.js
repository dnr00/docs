...
`),H,n(`
`),G,n(`
`),O])]),s("pre",j,[s("code",null,[Z,n(`
`),J,n(`
`),W,n(`
`),s("span",L,[s("span",Q,"  chainId: '"+l(a.constants.mainnetChainId)+"',",1)]),n(`
`),Y,n(`
`),s("span",z,[s("span",X,"  rpc: '"+l(a.constants.mainnetRpcUrl)+"',",1)]),n(`
...
`),s("span",Ws,[s("span",Ls,"  rest: '"+l(a.constants.arabicaRestUrl)+"'",1)]),n(`
`),Qs,n(`
`),Ys,n(`
`),zs])]),s("pre",Xs,[s("code",null,[$s,n(`
`),sn,n(`
`),nn,n(`
