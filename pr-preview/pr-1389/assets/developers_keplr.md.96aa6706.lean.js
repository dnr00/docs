...
`),j,n(`
`),G,n(`
`),H])]),s("pre",O,[s("code",null,[Q,n(`
`),J,n(`
`),X,n(`
`),s("span",z,[s("span",Y,"  chainId: '"+l(a.constants.mainnetChainId)+"',",1)]),n(`
`),L,n(`
`),s("span",W,[s("span",Z,"  rpc: '"+l(a.constants.mainnetRpcUrl)+"',",1)]),n(`
...
`),Os,n(`
`),s("span",Qs,[s("span",Js,"  rpc: '"+l(a.constants.arabicaRpcUrl)+"',",1)]),n(`
`),s("span",Xs,[s("span",zs,"  rest: '"+l(a.constants.arabicaRestUrl)+"'",1)]),n(`
`),Ys,n(`
`),Ls,n(`
`),Ws])]),s("pre",Zs,[s("code",null,[$s,n(`
`),sn,n(`
`),nn,n(`
