...
`),Q,n(`
`),Y,n(`
`),s("span",W,[s("span",z,"  chainId: '"+l(a.constants.mainnetChainId)+"',",1)]),n(`
`),X,n(`
`),s("span",L,[s("span",Z,"  rpc: '"+l(a.constants.mainnetRpcUrl)+"',",1)]),n(`
...
`),Ds,n(`
`),s("span",fs,[s("span",Is,"  rpc: '"+l(a.constants.mochaRpcUrl)+"',",1)]),n(`
...
`),s("span",Ys,[s("span",Ws,"  rest: '"+l(a.constants.arabicaRestUrl)+"'",1)]),n(`
`),zs,n(`
`),Xs,n(`
`),Ls])]),s("pre",Zs,[s("code",null,[$s,n(`
`),sn,n(`
`),nn,n(`
