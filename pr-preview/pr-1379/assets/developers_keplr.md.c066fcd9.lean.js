...
`),Is,n(`
`),s("span",Ds,[s("span",fs,"  rpc: '"+l(a.constants.mochaRpcUrl)+"',",1)]),n(`
`),s("span",Bs,[s("span",Ps,"  rest: '"+l(a.constants.mochaRestUrl)+"'",1)]),n(`
`),vs,n(`
`),Ns,n(`
`),Ss])])]),s("div",Rs,[xs,Ms,s("pre",Vs,[s("code",null,[Ks,n(`
`),Us,n(`
`),Hs,n(`
