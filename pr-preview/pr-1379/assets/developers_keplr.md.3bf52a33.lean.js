...
`),G,n(`
`),O,n(`
`),j])]),s("pre",H,[s("code",null,[W,n(`
`),Q,n(`
`),Z,n(`
`),s("span",z,[s("span",J,"  chainId: '"+l(a.constants.mainnetChainId)+"',",1)]),n(`
`),Y,n(`
`),s("span",L,[s("span",X,"  rpc: '"+l(a.constants.mainnetRpcUrl)+"',",1)]),n(`
