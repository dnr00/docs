...
`),As,n(`
`),Cs,n(`
`),ms])]),s("pre",bs,[s("code",null,[ws,n(`
`),Ts,n(`
`),ks,n(`
`),s("span",qs,[s("span",gs,"  chainId: '"+l(a.constants.mochaChainId)+"',",1)]),n(`
`),Ds,n(`
`),s("span",fs,[s("span",Bs,"  rpc: '"+l(a.constants.mochaRpcUrl)+"',",1)]),n(`
`),s("span",Is,[s("span",Ps,"  rest: '"+l(a.constants.mochaRestUrl)+"'",1)]),n(`
`),Ss,n(`
`),Ns,n(`
...
`),rn,n(`
`),En,n(`
`),yn])])])])])])}const Fn=y(b,[["render",_n]]);export{un as __pageData,Fn as default};
