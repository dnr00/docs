...
`),Ss,n(`
`),vs,n(`
`),Ns])])]),s("div",Rs,[xs,Ms,s("pre",Ks,[s("code",null,[Vs,n(`
`),Us,n(`
`),js,n(`
`),s("span",Gs,[s("span",Hs,"  chainId: '"+l(a.constants.arabicaChainId)+"',",1)]),n(`
`),Os,n(`
`),s("span",Ys,[s("span",Ls,"  rpc: '"+l(a.constants.arabicaRpcUrl)+"',",1)]),n(`
