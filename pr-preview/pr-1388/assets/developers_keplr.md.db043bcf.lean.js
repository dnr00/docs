...
`),z,n(`
`),Y,n(`
`),s("span",Z,[s("span",L,"  chainId: '"+l(a.constants.mainnetChainId)+"',",1)]),n(`
`),Q,n(`
`),s("span",W,[s("span",X,"  rpc: '"+l(a.constants.mainnetRpcUrl)+"',",1)]),n(`
